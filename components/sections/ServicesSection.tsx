...
const services = [
    ...
    {
        icon: Clock, // Placeholder for Lungs/Wind if not available, using generic health icon
    ...
    },
    {
        ...
        description: "Terapia complementaria para aumentar flujo sanguíneo, reducir inflamación y liberar toxinas musculares.",
        price: "$45.000",
        duration: "40 min",
        color: "text-cyan-600",
        bgColor: "bg-cyan-50",
    },
    {
        ...
        description: "Terapia funcional para secuelas de ACV, Parkinson y otras condiciones neurológicas.",
        price: "$65.000",
        duration: "60 min",
    ...
    },
    {
        ...
        description: "10 Sesiones combinadas (Kine + Acupuntura). Descuento especial para tratamientos continuos.",
        price: "$480.000",
    ...
    {
        icon: Home,
        title: "Kine a Domicilio",
        description: "Llevamos la rehabilitación a tu hogar con todo el equipamiento necesario (Valdivia, Concepción y Curanilahue).",
        price: "+$15.000",
        duration: "Adicional",
