                ...
                <ClientOnly>
                    ...
                    <div className="relative my-6">
                        ...
                        <div className="relative flex justify-center text-sm">
                            <span className="px-2 bg-white text-text-sec">O regístrate con</span>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <button
                            ...
                            className="w-full px-4 py-2 rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors flex items-center justify-center gap-2"
                        >
                        ...
                        <button
                            type="button"
                            onClick={() => signIn("azure-ad", { redirect: false, callbackUrl: "/dashboard" })}
                            className="w-full px-4 py-2 rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors flex items-center justify-center gap-2"
                        >
                            <svg className="w-5 h-5" viewBox="0 0 24 24">
                                <rect fill="currentColor" x="1" y="1" width="9" height="9" />
                                <rect fill="currentColor" x="14" y="1" width="9" height="9" />
                                <rect fill="currentColor" x="1" y="14" width="9" height="9" />
                                <rect fill="currentColor" x="14" y="14" width="9" height="9" />
                            </svg>
                            Microsoft
                        </button>
                        ...
                        <button
                            type="button"
                            onClick={() => signIn("facebook", { redirect: false, callbackUrl: "/dashboard" })}
                            className="w-full px-4 py-2 rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors flex items-center justify-center gap-2"
                        >
